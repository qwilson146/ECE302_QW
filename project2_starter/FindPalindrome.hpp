...
private:
	...
	/** 
	 * a vector that holds the words currently in the find palindrom
	 * each string will represent a word that has been added to the object
	 * will be stored in their original form ie capital letters lowercase and in the
	 * order of which they appeared
	*/
	
	std::vector<std::string> words;

	/**
	 * this is a vector within a vector that is found by using recursion of the palindrome search
	 * the inner vector or the two contains the words that will form the 
	 * valid palindrom when they are combined
	 * these combined (concatenated) palindroms will be created through the recursion
	 * 
	 */
